...
# Generated by qmake (2.01a) (Qt 4.6.3) on: mar. 8. mars 11:26:10 2011
# Project:  maets.pro
# Template: app
# Command: p:/dev/qt/2010.04/qt/bin/qmake.exe -spec ../qt/mkspecs/win32-g++ -win32 CONFIG+=release QMLJSDEBUGGER_PATH=P:/Dev/QtSDK/QtCreator/share/qtcreator/qml/qmljsdebugger -o Makefile maets.pro
#############################################################################
...
MAKEFILE      = Makefile
QMAKE         = p:\dev\qt\2010.04\qt\bin\qmake.exe
DEL_FILE      = rm
...
Makefile: maets.pro  ../qt/mkspecs/win32-g++/qmake.conf ../qt/mkspecs/qconfig.pri \
		...
		p:/Dev/Qt/2010.04/qt/lib/qtmain.prl
	$(QMAKE) -spec ../qt/mkspecs/win32-g++ -win32 CONFIG+=release QMLJSDEBUGGER_PATH=P:/Dev/QtSDK/QtCreator/share/qtcreator/qml/qmljsdebugger -o Makefile maets.pro
