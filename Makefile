...
# Generated by qmake (2.01a) (Qt 4.6.3) on: sam. 5. mars 19:14:38 2011
# Project:  maets.pro
# Template: app
# Command: p:/dev/qt/2010.04/qt/bin/qmake.exe -spec ../qt/mkspecs/win32-g++ -win32 CONFIG+=release -o Makefile maets.pro
#############################################################################
...
Makefile: maets.pro  ../qt/mkspecs/win32-g++/qmake.conf ../qt/mkspecs/qconfig.pri \
	...
	$(QMAKE) -spec ../qt/mkspecs/win32-g++ -win32 CONFIG+=release -o Makefile maets.pro
